"use client";
import RolePermissionAssign from "@/components/tables/RolePermissionAssign";
import { Context } from "@/contextApi/AuthContext";
import { contextType } from "@/contextApi/CreateDataContext";
import { Megaphone, Network, User, Users } from "lucide-react";
  ...
  return (
    <>
      <div className="text-left flex bg-white p-2 border-gray-300 border rounded-md my-2 mx-auto">
        ...
        <h1 className="text-xl font-semibold text-gray-900 m-0 p-0">Role Permission Assign</h1>
      </div>
